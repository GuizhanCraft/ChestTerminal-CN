...
public class AccessTerminal extends SimpleSlimefunItem<BlockTicker> {
    ...
    public AccessTerminal(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        ...
        new BlockMenuPreset(getId(), "&3CT访问终端") {
            ...
            public void newInstance(BlockMenu menu, Block b) {
                menu.replaceExistingItem(46, new CustomItemStack(SlimefunUtils.getCustomHead("f2599bd986659b8ce2c4988525c94e19ddd39fad08a38284a197f1b70675acc"), "&7\u21E6 上一页", "", "&c可能需要花费一点时间", "&c请勿频繁点击"));
                ...
                menu.replaceExistingItem(50, new CustomItemStack(SlimefunUtils.getCustomHead("c2f910c47da042e4aa28af6cc81cf48ac6caf37dab35f88db993accb9dfe516"), "&7下一页 \u21E8", "", "&c可能需要花费一点时间", "&c请勿频繁点击"));
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        preset.addItem(46, new CustomItemStack(Material.RED_STAINED_GLASS_PANE, "这里稍后会更新"));
        ...
        preset.addItem(50, new CustomItemStack(Material.RED_STAINED_GLASS_PANE, "这里稍后会更新"));
    ...
    public BlockTicker getItemHandler() {
        return new BlockTicker() {
            ...
            private final ItemStack item = new CustomItemStack(Material.BARRIER, "&4未连接到货运网络!");
